...
ggplot(data = Western_Europe,
       aes(x = Year,
           ...
           color = Entity)) +
  geom_line() +
  labs(title = "Long-term homicide rates across Western Europe",
       x = "Year",
...
Western_Europe %>% 
  ...
  labs(title = "Long-term homicide rates by country",
       x = "Year",
       y = "Homicides per 100,000 people",
       color = "Country") +
  theme_minimal()
...
danish_kings <- read_csv2("data/danish_kings.csv")
...
#The homicide rate clearly shows a big decline in homicide rates across Europe, so if one was to exclusively look at the countries from the data, we are more civilized, for the simple reason there are barely a fraction of the homicides that used to occure, and the line is approaching zero